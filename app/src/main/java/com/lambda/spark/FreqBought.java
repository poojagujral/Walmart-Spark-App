 ...
 */
public class FreqBought extends Fragment implements HorizontalProductScrollAdapter.OnNoteListener {
...
//        private CategoryAdapter categoryAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.freq_bought, container, false);
...
//        });
        ...
        horizontalProductModelList.add(new HorizontalProductModel(R.drawable.freq1, "Hand Sanatizer", "$10","Sanitary"));
        horizontalProductModelList.add(new HorizontalProductModel(R.drawable.freq2, "Handwash", "$12","Sanitary"));
        horizontalProductModelList.add(new HorizontalProductModel(R.drawable.freq3, "Clinical Cotton","$5","Sanitary"));
